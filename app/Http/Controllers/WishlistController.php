...
class WishlistController extends Controller
{
    ...
    public function wishlist(Request $request){
        ...
        if($already_wishlist) {
            request()->session()->flash('error', 'This product is already in your wishlist. Consider adding something else!');
            return back();
        }else{
        ...
        request()->session()->flash('success','Product successfully added to the wishlist!');
        return back();       
    }  
    ...
    public function wishlistDelete(Request $request){
        ...
        if ($wishlist) {
            $wishlist->delete();
            request()->session()->flash('success','Wishlist deleted successfully!');
            return back();  
        }
